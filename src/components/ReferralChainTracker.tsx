                    ...
                    <div className="flex items-center gap-2">
                      {stats.pending > 0 && (
                        <div className="flex items-center gap-0.5">
                          <Clock className="w-2.5 h-2.5" style={{ color: '#F59E0B' }} />
                          <span className="text-[9px] font-bold" style={{ color: '#F59E0B' }}>{stats.pending}</span>
                        </div>
                      )}
                      {stats.accepted > 0 && (
                        <div className="flex items-center gap-0.5">
                          <CheckCircle2 className="w-2.5 h-2.5" style={{ color: '#4ADE80' }} />
                          <span className="text-[9px] font-bold" style={{ color: '#4ADE80' }}>{stats.accepted}</span>
                        </div>
                      )}
              ...
              <div key={ref._id} className="flex items-center gap-3 p-2.5 rounded-xl cursor-pointer transition-all"
                ...
                <div className="flex flex-col items-end gap-0.5 flex-shrink-0">
                  ...
                  {ref.urgency && ref.urgency !== 'routine' && (
                    <div className="flex items-center gap-0.5">
                      <AlertTriangle className="w-2.5 h-2.5" style={{ color: ref.urgency === 'emergency' ? '#EF4444' : '#F59E0B' }} />
                      <span className="text-[8px] font-bold" style={{ color: ref.urgency === 'emergency' ? '#EF4444' : '#F59E0B' }}>
